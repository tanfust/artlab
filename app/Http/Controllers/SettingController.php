...
class SettingController extends Controller
{
    public function index()
    {
        ...
        return view('back-office/Setting',['User_personal_Info'=>$User_personal_Info,'PaymentMethod'=>$PaymentMethod,'LoginActivity'=>$LoginActivity,'FAQ'=>$FAQ,'TermsAndCondition'=>$TermsAndCondition]);
    }
