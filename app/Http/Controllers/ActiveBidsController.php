...
class ActiveBidsController extends Controller
{
    public function index()
    {
        ...
        return view('back-office/Auction', ['AllNFTSUpdateV2' => $AllNFTSUpdateV2, 'AllNFTSUpdateV3' => $AllNFTSUpdateV3, 'AllBids' => $AllBids, 'AllNFTSUpdate' => $AllNFTSUpdate, 'ActiveBids' => $ActiveBids, 'Artworks' => $Artworks]);
    }
}