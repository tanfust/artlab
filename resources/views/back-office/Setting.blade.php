                                    ...
                                    <div class="nftmax-psidebar">
                                        ...
                                        <div class="list-group nftmax-psidebar__list" id="list-tab" role="tablist">
                                            <a class="list-group-item active" data-bs-toggle="list" href="#id1"
                                                role="tab"><span class="nftmax-psidebar__icon"><svg width="15"
                                                        height="20" viewBox="0 0 15 20" class="fill-current"
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id2"
                                                role="tab"><span class="nftmax-psidebar__icon"><svg width="19"
                                                        height="14" viewBox="0 0 19 14" class="fill-current"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id3"
                                                role="tab"><span class="nftmax-psidebar__icon"><svg width="19"
                                                        height="19" viewBox="0 0 19 19" class="fill-current"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id4"
                                                role="tab"><span class="nftmax-psidebar__icon"><svg width="14"
                                                        height="20" viewBox="0 0 14 20" class="fill-current"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id5"
                                                role="tab"><span class="nftmax-psidebar__icon"><svg
                                                        class="inline fill-current" width="18" height="21"
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#id6"
                                                role="tab"><span class="nftmax-psidebar__icon"><svg width="17"
                                                    ...
                                                    <form action="#">
                                                                    ...
                                                                    <div class="nftmax-ptabs__form-main">
                                                                                ...
                                                                                <div class="col-lg-6 col-12">
                                                                                    <div
                                                                                        ...
                                                                                        <input
                                                                                            class="nftmax__item-input"
                                                                                            type="text"
                                                                                            value="{{ $User_personal_Info['last_name'] }}"
                                                                                            required="required">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="nftmax__item-form--group">
                                                                            ...
                                                                            <input class="nftmax__item-input"
                                                                                type="url"
                                                                                value="{{ $User_personal_Info['user_name'] }}"
                                                                                required="required">
                                                                        </div>
                                                                        ...
                                                                        <div class="nftmax__item-form--group">
                                                                            ...
                                                                            <input class="nftmax__item-input"
                                                                                type="email"
                                                                                value="{{ $User_personal_Info['email'] }}"
                                                                                required="required">
                                                                        ...
                                                                        <div class="nftmax-ptabs__sidebar">
                                                                            <div
                                                                                ...
                                                                                <div class="nftmax-ptabs__sauthor">
                                                                                    <div
                                                                                        ...
                                                                                        <img src="{{ asset($User_personal_Info['profile_image']) }}"
                                                                                            alt="#">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="nftmax-ptabs__sauthor">
                                                                                    <div
                                                                                        class="nftmax-ptabs__sauthor-img nftmax-ptabs__pthumb">
                                                                                        <img src="{{ $User_personal_Info['cover_image'] }}"
                                                                                            alt="#">
                                                                                        <label for="file-input"><span
                                                                                                class="nftmax-ptabs__sedit"><svg
                                                                                                    width="32"
                                                        ...
                                                        <div class="nftmax__item-button--group nftmax__ptabs-bottom">
                                                            ...
                                                            <a class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius "
                                                                href="{{ url('/my-profile') }}" type="submit">Update
                                                                Profile</a>
                                                        </div>
                                                    </form>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    <div
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            type="submit">Change Password</input>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                            <!-- End Sign in Form -->
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-12">
                                                            <div class="nftmax-password__img">
                                                                <img src="assets/img/password-reset.png"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="accordion-item nftmax-accordion__single">
                                                                <h2 class="accordion-header" id="nftac-1">
                                                                    <button
                                                                        ...
                                                                        aria-expanded="false"
                                                                        aria-controls="ac-collapseOne">{{ $FAQ['0'] }}</button>
                                                                </h2>
