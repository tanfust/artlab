                                                ...
                                                <li class="nftmax-balance__all-single">
                                                    ...
                                                    <div class="nftmax-balance-desc">
                                                        <div class="nftmax-balance-desc__main">
                                                            ...
                                                            <p class="nftmax-balance__sub">New Add
                                                                <span>+{{ $MyWellat['3'] }}</span>
                                                            </p>
                                                        </div>
                                                        <div class="nftmax-dots"><img src="assets/img/dots.png"
                                                                alt="#"></div>
                                                    </div>
                                                </li>
                                            @endforeach
                                    ...
                                    <div class="charts-main  mg-top-40">
                                                ...
                                                <ul class="nav nav-tabs nftmax-dropdown__list" id="nav-tab"
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        <a class="nftmax-sidebar_btn nftmax-heading__tabs nav-link dropdown-toggle"
                                                            ...
                                                            aria-expanded="false">Last 15 days <span><svg width="13"
                                                        ...
                                                        <ul class="dropdown-menu nftmax-sidebar_dropdown">
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#s_history" role="tab">Last 15
                                                                Daily</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#s_history_weekly"
                                                                role="tab">Weekly</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#s_history_monthly"
                                                                role="tab">Monthly</a>
                                                        </ul>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="charts-main__three">
                                            <div class="tab-content" id="nav-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="s_history_monthly" role="tabpanel"
                                                    aria-labelledby="nav-home-tab">
                                                    <canvas id="myChart_three_monthly"></canvas>
                                                </div>
                                                <div class="tab-pane fade" id="s_history_weekly" role="tabpanel"
                                                    aria-labelledby="nav-home-tab">
                                                            ...
                                                            <li class="nftmax-newtrans__single">
                                                                <div class="nftmax-newtrans__info">
                                                                    <div class="nftmax-newtrans__icon"><img
                                                                            src="{{ asset($RecentTransaction['0']) }}"
                                                                            alt="#"></div>
                                                                    <h4 class="nftmax-newtrans__added">
                                                                        {{ $RecentTransaction['1'] }}<span>{{ $RecentTransaction['2'] }}</span>
                                                                    </h4>
                                                                </div>
                                                                <div
                                                                    class="nftmax-balance-amount nftmax-newtrans__amount">
                                                                    <h4 class="nftmax-balance-amount">
                                                                        <b>$</b>{{ $RecentTransaction['3'] }}
                                                                    </h4>
                                                                    <p class="nftmax-balance__sub"><span
                                                                            class="nftmax-newtrans__credit">+{{ $RecentTransaction['4'] }}</span>
                                                                    </p>
                                                                </div>
                                                            </li>
                                                        @endforeach
                                                    ...
                                                    <ul class="nftmax-newtrans__list">
                                                        @foreach ($RecentTransactionSend as $RecentTransactionSend)
                                                            <li class="nftmax-newtrans__single">
                                                                <div class="nftmax-newtrans__info">
                                                                    <div class="nftmax-newtrans__icon"><img
                                                                            src="{{ asset($RecentTransactionSend['0']) }}"
                                                                            alt="#"></div>
                                                                    <h4 class="nftmax-newtrans__added">
                                                                        {{ $RecentTransactionSend['1'] }}<span>{{ $RecentTransactionSend['2'] }}</span>
                                                                    </h4>
                                                                </div>
                                                                <div
                                                                    class="nftmax-balance-amount nftmax-newtrans__amount">
                                                                    <h4 class="nftmax-balance-amount">
                                                                        <b>$</b>{{ $RecentTransactionSend['3'] }}
                                                                    </h4>
                                                                    <p class="nftmax-balance__sub"><span
                                                                            class="nftmax-newtrans__credit">+{{ $RecentTransactionSend['4'] }}</span>
                                                                    </p>
                                                                </div>
                                                            </li>
                                                        @endforeach
                                                    ...
                                                    <ul class="nftmax-newtrans__list">
                                                        @foreach ($RecentTransactionRecent as $RecentTransactionRecent)
                                                            <li class="nftmax-newtrans__single">
                                                                <div class="nftmax-newtrans__info">
                                                                    <div class="nftmax-newtrans__icon"><img
                                                                            src="{{ asset($RecentTransactionRecent['0']) }}"
                                                                            alt="#"></div>
                                                                    <h4 class="nftmax-newtrans__added">
                                                                        {{ $RecentTransactionRecent['1'] }}<span>{{ $RecentTransactionRecent['2'] }}</span>
                                                                    </h4>
                                                                </div>
                                                                <div
                                                                    class="nftmax-balance-amount nftmax-newtrans__amount">
                                                                    <h4 class="nftmax-balance-amount">
                                                                        <b>$</b>{{ $RecentTransactionRecent['3'] }}
                                                                    </h4>
                                                                    <p class="nftmax-balance__sub"><span
                                                                            class="nftmax-newtrans__credit">+{{ $RecentTransactionRecent['4'] }}</span>
                                                                    </p>
                                                                </div>
                                                            </li>
                                                        @endforeach
                                                ...
                                                <ul class="nav nav-tabs nftmax-dropdown__list" id="nav-tab"
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        <ul class="dropdown-menu nftmax-sidebar_dropdown">
                                                            ...
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#chart__investment15_days"
