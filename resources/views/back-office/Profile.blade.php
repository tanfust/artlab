                            ...
                            <div class="nftmax-userprofile__user">
                                <div class="nftmax-userprofile__content">
                                    ...
                                    <div class="nftmax-userprofile__info">
                                        ...
                                        <p class="nftmax-userprofile__info-text"> {{ $User['bio'] }} <a
                                                href="#">Read More</a></p>
                                        <ul class="nftmax-userprofile__meta">
                                            <li class="nftmax-userprofile__meta" data-bs-toggle="modal"
                                                data-bs-target="#followers_modal"><a href="#"><span
                                                        class="nftmax-userprofile__number">{{ $User['followers'] }}</span>
                                                    Followers</a></li>

                                            <!-- Preview Product -->
                                            <div class="nftmax-preview__modal modal fade" id="followers_modal"
                                                    ...
                                                    <div class="modal-content nftmax-preview__modal-content">
                                                        <div class="modal-header nftmax__modal__header">
                                                            <h4 class="modal-title nftmax-preview__modal-title"
                                                                id="previewModalLabel">Followers</h4>
                                                            <button type="button"
                                                        ...
                                                        <div class="modal-body nftmax-modal__body">
                                                            ...
                                                            <ul class="followers-list">
                                                                ...
                                                                <li class="followers-list__single">
                                                                    <div class="followers-list__first">
                                                                        <div class="followers-list__follower">
                                                                            <img src="assets/img/follower.png"
                                                                                alt="#">
                                                                            <div class="followers-list__badge"><img
                                                                                    src="assets/img/badge.png"
                                                                                    alt="#"></div>
                                                                        </div>
                                                                        <div class="followers-list__content">
                                                                            <h4 class="followers-list__title">Guy
                                                                                Hawkins</h4>
                                                                            <p href="#"
                                                                                class="followers-list__text">34.k
                                                                                followers</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="followers-list__button">
                                                                        <a href="#"
                                                                            class="nftmax-btn nftmax-btn__bordered nftmax-btn__followed radius btn btn-primary btn-lg disabled"
                                                                            tabindex="-1" role="button"
                                                                            aria-disabled="true"><span
                                                                                class="ntfmax__btn-textgr">Following</span></a>
                                                                    </div>
                                                                </li>
                                                                <!-- End SIngle Follower -->
                                                                <!-- SIngle Follower -->
                                                                <li class="followers-list__single">
                                                                    ...
                                                                    <div class="followers-list__button">
                                                                        <a
                                                                            class="nftmax-btn nftmax-btn__bordered bg radius">Follow</a>
                                                                    </div>
                                                                </li>
                                                                <!-- End SIngle Follower -->
                                                                <!-- SIngle Follower -->
                                            ...
                                            <!-- End Preview Product -->
                                            <li class="nftmax-userprofile__meta"><a href="#"><span
                                                        class="nftmax-userprofile__number">35</span> Following</a></li>
                                            <li class="nftmax-userprofile__meta"><a href="#"><span
                                                        class="nftmax-userprofile__number">{{ $User['favorite'] }}</span>
                                                    Favorites</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="nftmax-userprofile__right">
                                    <a href="#"
                                        ...
                                        Profile</a>
                                    <a href="#" class="nftmax-btn nftmax-btn__share radius"><svg width="23"
                            ...
                            <div class="nftmax-pcats__bar">
                                <div class="nftmax-pcats__list list-group " id="list-tab" role="tablist">
                                    <a class="list-group-item active" data-bs-toggle="list" href="#tab_1"
                                        role="tab" href="profile.html">On Sale<span
                                            class="nftmax-pcats__count">{{ count($OnSale) }}</span></a>
                                    <a class="list-group-item" data-bs-toggle="list" href="#tab_2"
                                        role="tab">Owned<span
                                            class="nftmax-pcats__count">{{ count($Owned) }}</span></a>
                                    <a class="list-group-item" data-bs-toggle="list" href="#tab_3"
                                        role="tab">Created<span
                                            class="nftmax-pcats__count">{{ count($CreateforSell) + count($CreateforBits) }}</span></a>
                                    <a class="list-group-item" data-bs-toggle="list" href="#tab_4"
                                        role="tab">Hidden<span
                                            class="nftmax-pcats__count">{{ count($CreateforSellHidden) + count($CreateforBitsHidden) }}</span></a>
                                    <a class="list-group-item" data-bs-toggle="list" href="#tab_5"
                                        role="tab">Collections<span
                                            class="nftmax-pcats__count">{{ count($collection) }}</span></a>
                                    <a class="list-group-item" data-bs-toggle="list" href="#tab_6"
                                        role="tab">Activity</a></li>
                                </div>
                                <a href="{{ url('/upload-product') }}"
                                    class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius">Upload
                                    Product</a>
                            </div>
                            <!-- End Profile Menu -->
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <div class="trending-action__single trending-action__single--v2">
                                                        ...
                                                        <div class="nftmax-trendmeta__main">
                                                            <div class="nftmax-trendmeta__author">
                                                                <div class="nftmax-trendmeta__img">
                                                                    <img src="{{ asset($OnSale['0']) }}"
                                                                        alt="#">
                                                                </div>
                                                                <div class="nftmax-trendmeta__content">
                                                                    <span class="nftmax-trendmeta__small">Owned
                                                                        by</span>
                                                            ...
                                                            <div class="nftmax-trendmeta__author">
                                                                <div class="nftmax-trendmeta__content">
                                                                    <span class="nftmax-trendmeta__small">Create
                                                                        by</span>
                                                                    <h4 class="nftmax-trendmeta__title">
                                                                        {{ $OnSale['2'] }}</h4>
                                                                </div>
                                                                <div class="nftmax-trendmeta__img">
                                                                    <img src="{{ asset($OnSale['3']) }}"
                                                                        alt="#">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="trending-action__head">
                                                        @if ($OnSale['4'] == 1)
                                                            <div class="trending-action__badge"><span>Active</span>
                                                            </div>
                                                        @else
                                                            <div class="trending-action__badge"><span>close</span>
                                                            </div>
                                                        @endif
                                                    ...
                                                    <div class="trending-action__body trending-marketplace__body">
                                                        <h2 class="trending-action__title"><a
                                                                href="marketplace-details.html">{{ $OnSale['6'] }}</a>
                                                        </h2>
                                                            ...
                                                            <div class="nftmax-currency__main">
                                                                ...
                                                                <div class="nftmax-currency__content">
                                                                    <h4 class="nftmax-currency__content-title">
                                                                        {{ $OnSale['8'] }} ETH </h4>
                                                                    <p class="nftmax-currency__content-sub">(773.69
                                                                        USD)</p>
                                                                </div>
                                                            </div>
                                                            <a href="#"
                                                                class="nftmax-btn nftmax-btn__secondary radius">On
                                                                Sale</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="trending-action__body">
                                                        <div class="trending-action__author-meta">
                                                            <div class="trending-action__author-img"><img
                                                                    src="{{ asset($Owned['1']) }}" alt="#">
                                                            </div>
                                                            <p class="trending-action__author-name">Owned by <a
                                                                    href="profile.html">{{ $Owned['2'] }}</a></p>
                                                        </div>
                                                        <h2 class="trending-action__title"><a
                                                                href="active-bids.html">{{ $Owned['3'] }}</a></h2>
                                                        <div class="dashboard-banner__bid dashboard-banner__bid-v2">
                                                            ...
                                                            <div
                                                                ...
                                                                <h3 class="dashboard-banner__group-title"
                                                                    id="CountDown" data-countdown="2023/09/01"></h3>
                                                            </div>
                                                            <!-- End Single Bid -->
                                                        </div>
                                                    </div>
                                        ...
                                        @foreach ($CreateforBits as $CreateforBits)
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <div class="trending-action__single nftmax-pd-20">
                                                    ...
                                                    <div class="trending-action__body trending-marketplace__body">
                                                        <h2 class="trending-action__title"><a
                                                                href="marketplace-details.html">{{ $CreateforBits['6'] }}</a>
                                                        </h2>
                                                        <div class="nftmax-currency">
                                                            <div class="nftmax-currency__main">
                                                                <div class="nftmax-currency__icon"><img
                                                                ...
                                                                <div class="nftmax-currency__content">
                                                                    <h4 class="nftmax-currency__content-title">
                                                                        {{ $CreateforBits['8'] }} ETH </h4>
                                                                    <p class="nftmax-currency__content-sub">
                                                                        ({{ $CreateforBits['9'] }} USD)
                                                                    </p>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-xxl-3 col-lg-3 col-md-6 col-12">
                                                ...
                                                <div class="trending-action__single nftmax-pd-20">
                                                    ...
                                                    <div class="trending-action__body">
                                                        <div class="trending-action__author-meta">
                                                            <div class="trending-action__author-img"><img
                                                                    src="{{ asset($CreateforSell[1]) }}"
                                                                    alt="#"></div>
                                                            <p class="trending-action__author-name">Owned by <a
                                                                    href="#">{{ $CreateforSell[2] }}</a></p>
                                                        </div>
                                                        <h2 class="trending-action__title"><a
                                                                href="#">{{ $CreateforSell[3] }}</a></h2>
                                                        <div class="dashboard-banner__bid dashboard-banner__bid-v2">
                                                            <!-- Single Bid -->
                                                            <div
                                                                class="dashboard-banner__group dashboard-banner__group-v2">
                                                ...
                                                <div class="nftmax-collection__single">
                                                    ...
                                                    <div class="nftmax-collection__body">
                                                        <div class="row g-2">
                                                            <div class="col-6">
                                                                <a href="#"><img class="nftmax-collection__img"
                                                                        src="{{ asset($collection['1']) }}"
                                                                        alt="#"></a>
                                                            </div>
                                                            <div class="col-6">
                                                                <a href="#"><img class="nftmax-collection__img"
                                                                        src="{{ asset($collection['2']) }}"
                                                                        alt="#"></a>
                                                            </div>
                                                        </div>
                                                        <div class="nftmax-collection__author">
                                                            <div class="nftmax-collection__author-head">
                                                                <a href="#">
                                                                    <img src="{{ asset($collection['3']) }}"
                                                                        alt="#">
                                                                    <h4 class="nftmax-collection__title">
                                                                        {{ $collection['4'] }}</h4>
                                                                </a>
                                                            </div>
                                                            <div class="nftmax-collection__item"><a
                                                                    href="#">{{ $collection['5'] }} Item</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="nftmax-table__column-3 nftmax-table__data-3">
                                                            <div class="nftmax-table__amount nftmax-table__text-two">
                                                                <img src="{{ asset($Activity[3]) }}"
                                                                    alt="#"><span
                                                                    class="nftmax-table__text">{{ $Activity['4'] }}
                                                                    $</span>
                                                            </div>
                                                        </td>
