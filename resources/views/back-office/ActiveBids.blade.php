                                            ...
                                            <div class="nftmax-header__author nftmax-header__author-two ">
                                                ...
                                                <div class="nftmax-header__author-content ">
                                                    ...
                                                    <p
                                                        ...
                                                        <a href="#"
                                                            class="nftmax-font-regular nftmax-lspacing">bid user
                                                            name</a>
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                                    ...
                                                    <div class="nftmax__item-form--main">
                                                        ...
                                                        <div class="nftmax__item-form--group ntfmax__item-form--radio">
                                                            <div class="ntfmax__item-radio--inner">
                                                                ...
                                                                <div class="ntfmax__item-radio--disable">
                                                                    ...
                                                                    <input type="radio" name="select" "option-2"
                                                                        id="option-2">
                                                                    <input type="radio" name="select" "option-3"
                                                                        id="option-3">
                                                                </div>
                                                                <div class="ntfmax__item-radio--group">
                                                                    <label for="option-1" class="option option-1">
                                                                            ...
                                                                            <svg width="26" height="38"
                                                                                ...
                                                                                <defs>
                                                                                    ...
                                                                                    <linearGradient
                                                                                        ...
                                                                                        x1="9.8799" y1="19.3989"
                                                                                        x2="19.514" y2="24.5763"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                        ...
                                                                        <span class="ntfmax__item-radio-title">Fixed
                                                                            price</span>
                                                                    </label>
                                                                    <label for="option-2" class="option option-2">
                                                                        <span class="item-input-icon">
                                                                            <svg width="31" height="31"
                                                                                ...
                                                                                <defs>
                                                                                    <linearGradient
                                                                                        id="paint0_linear_0_1"
                                                                                        x1="4.49023" y1="3.04474"
                                                                                        x2="31.8937" y2="29.8789"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                                    ...
                                                                                    <linearGradient
                                                                                        ...
                                                                                        x1="1.55469" y1="11.6414"
                                                                                        x2="11.2005" y2="21.0545"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                        ...
                                                                        <span class="ntfmax__item-radio-title">Open for
                                                                            bids</span>
                                                                    </label>
                                                                    <label for="option-3" class="option option-3">
                                                                        <span class="item-input-icon">
                                                                            <svg width="21" height="32"
                                                                                viewBox="0 0 21 32" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                                <path
                                                                                ...
                                                                                <defs>
                                                                                    ...
                                                                                    <linearGradient
                                                                                        id="paint2_linear_0_1"
                                                                                        x1="3.88867" y1="24.1111"
                                                                                        x2="6.15335" y2="31.6472"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                                    ...
                                                                                    <linearGradient
                                                                                        id="paint3_linear_0_1"
                                                                                        x1="10.1113" y1="18.6667"
                                                                                        x2="10.9328" y2="19.4707"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                                    ...
                                                                                    <linearGradient
                                                                                        ...
                                                                                        x1="10.8887" y1="22.5555"
                                                                                        x2="11.7101" y2="23.3595"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                                    ...
                                                                                    <linearGradient
                                                                                        ...
                                                                                        x1="9.33398" y1="23.3333"
                                                                                        x2="10.1555" y2="24.1373"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                                    ...
                                                                                    <linearGradient
                                                                                        ...
                                                                                        x1="10.8887" y1="19.4445"
                                                                                        x2="11.7101" y2="20.2485"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                                    ...
                                                                                    <linearGradient
                                                                                        ...
                                                                                        x1="10.8887" y1="17.8889"
                                                                                        x2="11.7101" y2="18.6929"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                                    ...
                                                                                    <linearGradient
                                                                                        ...
                                                                                        x1="10.1113" y1="16.3333"
                                                                                        x2="10.9328" y2="17.1373"
                                                                                        gradientUnits="userSpaceOnUse">
                                                                                        <stop stop-color="#F539F8">
                                                                                        </stop>
                                                                                        <stop offset="0.416763"
                                                                        ...
                                                                        <span class="ntfmax__item-radio-title">Timed
                                                                            auction</span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="ntfmax__item-radio--inner">
                                                                ...
                                                                <div
                                                                    class="ntfmax__item-radio--group ntfmax__item-radio--collection">
                                                        ...
                                                        <div
                                                            class="nftmax__item-form--group nftmax__item-form--unlock">
                                        ...
                                        <div class="nftmax__item-button--group">
                                            ...
                                            <button
                                                class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered--plus radius nftmax-item__btn"
                                                data-bs-toggle="modal" data-bs-target="#preview_modal"><span
                                                    class="ntfmax__btn-textgr">Preview</span></button>
                                            <button
                                            ...
                                            <div class="nftmax-preview__modal modal fade" id="preview_modal"
                                                tabindex="-1" aria-labelledby="previewModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog  nftmax-preview__modal-preview">
                                                    <div class="modal-content nftmax-preview__modal-content"
                                                        ...
                                                        <div class="modal-header nftmax__modal__header">
                                                            <h4 class="modal-title nftmax-preview__modal-title"
                                                                id="previewModalLabel">Item Preview</h4>
                                                            <button type="button"
                                                        ...
                                                        <div class="modal-body nftmax-modal__body">
                                                            ...
                                                            <div class="trending-action__single">
                                                                ...
                                                                <div class="trending-action__body">
                                                                    ...
                                                                    <h2 class="trending-action__title"><a
                                                                            href="#">Interconnected Planes</a>
                                                                    </h2>
                                                                    <div
                                                                        class="dashboard-banner__bid dashboard-banner__bid-v2">
                                                                        <!-- Single Bid -->
                                                                        <div
                                                            ...
                                                            <div class="nftmax__item-button--group">
                                                                <button
                                                                    class="nftmax__item-button--single nftmax__item-button--cancel"
                                                                    data-bs-dismiss="modal">Cancel</button>
                                                                <button
                                                                    class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius "
                                                                    type="submit">Create Now
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="nftmax__item-button--group">
                                                                    <button
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            type="submit"><span
                                                                                class="ntfmax__btn-textgr"
                                                                                data-bs-dismiss="modal"
                                                                                aria-label="Close">Not now</span>
                                                                        </button>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="nftmax-funfact mg-top-40">
                            ...
                            <div class="nftmax-funfact__single">
                                <div class="nftmax-funfact__icon">
                                    <img class="nftmax-funfact__img" src="assets/img/funfact-icon.png"
                                        alt="#">
                                </div>
                                <div class="nftmax-funfact__content">
                                    <h3 class="nftmax-funfact__title"><b
                                            class="number">{{ $Artworks['artworkNo'] }}</b><span>K</span></h3>
                            ...
                            <div class="nftmax-funfact__single">
                                <div class="nftmax-funfact__icon">
                                    <img class="nftmax-funfact__img nftmax-funfact__img--v2"
                                        src="assets/img/funfact-icon-2.png" alt="#">
                                </div>
                                <div class="nftmax-funfact__content">
                                    <h3 class="nftmax-funfact__title"><b
                                            class="number">{{ $Artworks['activeArtwirk'] }}</b><span>K</span></h3>
                                    <p class="nftmax-funfact__text">Artworks</p>
                                </div>
                            </div>
                            <!-- End NFTMax Single -->
                            ...
                            <div class="nftmax-funfact__single">
                                <div class="nftmax-funfact__icon">
                                    <img class="nftmax-funfact__img  nftmax-funfact__img--v3"
                                        src="assets/img/funfact-icon-3.png" alt="#">
                                </div>
                                <div class="nftmax-funfact__content">
                                    <h3 class="nftmax-funfact__title"><b
                                            class="number">{{ $Artworks['current_bids'] }}</b><span>K</span></h3>
                                    <p class="nftmax-funfact__text">Artworks</p>
                                </div>
                            </div>
                            <!-- End NFTMax Single -->
                            ...
                            <div class="nftmax-funfact__single nftmax-funfact__single--v4">
                                <div class="nftmax-funfact__icon">
                                    <img class="nftmax-funfact__img nftmax-funfact__img--v4"
                                        src="assets/img/funfact-icon-4.png" alt="#">
                                </div>
                                <div class="nftmax-funfact__content">
                                    <h3 class="nftmax-funfact__title"><b
                                            class="number">{{ $Artworks['close_artwork'] }}</b><span>K</span></h3>
                                    <p class="nftmax-funfact__text">Artworks</p>
                                </div>
                            </div>
                            <!-- End NFTMax Single -->
                                        ...
                                        <div class="dashboard-banner__column dashboard-banner__column--one">
                                            ...
                                            <div class="nftmax-header__author nftmax-header__author-two ">
                                                <div class="nftmax-header__author-img"><img
                                                        src="{{ asset($ActiveBids['user_image']) }}" alt="#">
                                                </div>
                                                <div class="nftmax-header__author-content ">
                                                    <h4
                                                        class="nftmax-header__author-title nftmax-header__author-title--two">
                                                        {{ $ActiveBids['user'] }}</h4>
                                                    <p
                                                        class="nftmax-header__author-text nftmax-header__author-text--two">
                                                        <a href="#">{{ $ActiveBids['user_name'] }}</a>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="dashboard-banner__bids">
                                                <div class="dashboard-banner__bid">
                                                    ...
                                                    <div class="dashboard-banner__group">
                                                        <p class="dashboard-banner__group-small">Current Bid</p>
                                                        <h3 class="dashboard-banner__group-title">
                                                            {{ $ActiveBids['current_bids'] }} ETH</h3>
                                                        <p class="dashboard-banner__group-small">
                                                            {{ $ActiveBids['usd_rate'] }} <span>USD</span></p>
                                                    </div>
                                                    <!-- End Single Bid -->
                                                    <div class="dashboard-banner__middle-border"></div>
                                                    <!-- Single Bid -->
                                                    <div class="dashboard-banner__group">
                                                        <p class="dashboard-banner__group-small">Remaing Time</p>
                                                        <h3 class="dashboard-banner__group-title"
                                                            data-countdown="{{ $ActiveBids['count_down_from'] }}">
                                                        </h3>
                                                        <p class="dashboard-banner__group-small nftmax-timing">
                                                            <span>Hrs</span> <span>Min</span> <span>Sec</span>
                                                        </p>
                                            ...
                                            <div class="dashboard-banner__button">
                                                ...
                                                <div class="dashboard-banner__single-btn">
                                                    <a class="dashboard-banner__btn"><a
                                                            href="{{ url('/active-bids') }}"
                                                            class="nftmax-btn nftmax-btn__secondary radius">Place a
                                                            Bid</a></a>
                                                </div>
                                                <div class="dashboard-banner__single-btn">
                                                    <a class="dashboard-banner__btn"><a
                                                            href="{{ url('/market-place') }}"
                                                            class="nftmax-btn trs-white">View Atwork</a></a>
                                                </div>
                                            </div>
                                            <!-- End Dashboard Banner Button -->
                                        </div>
                                        ...
                                        <div class="trending-action__single">
                                            ...
                                            <div class="dashboard-banner__button trending-action__bottom">
                                                <a href="{{ url('/active-bids') }}"
                                                    class="nftmax-btn nftmax-btn__secondary radius">Place a Bid</a>
                                                <a href="{{ url('/market-place') }}"
                                                    class="nftmax-btn trs-white">View Atwork</a>
                                            </div>
                                        </div>
