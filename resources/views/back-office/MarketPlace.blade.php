                            ...
                            <div class="nftmax-marketplace__bar-inner">
                                ...
                                <div class="list-group nftmax-marketplace__bar-list" id="list-tab" role="tablist">
                                    ...
                                    <a class="list-group-item" data-bs-toggle="list" href="#id2"
                                        role="tab">Featured Artist</a>
                                    <a class="list-group-item" data-bs-toggle="list" href="#id3" role="tab">Open
                                        Market</a>
                                    <a class="list-group-item" data-bs-toggle="list" href="#id4"
                                        role="tab">Partner Shops</a>
                                    <a class="list-group-item" data-bs-toggle="list" href="#id5" role="tab">Game
                                        Assets</a>
                                </div>
                                            ...
                                            <div class="row nftmax-gap-sq30">
                                                @foreach ($Explore as $Explore)
                                                    <div class="col-lg-4 col-md-6 col-12">
                                                        ...
                                                        <div
                                                            class="trending-action__single trending-action__single--v2">
                                                            ...
                                                            <!-- Trending Body -->
                                                            <div
                                                                class="trending-action__body trending-marketplace__body">
                                                                <h2 class="trending-action__title"><a
                                                                        href="{{ url('/market-place') }}">{{ $Explore['6'] }}</a>
                                                                </h2>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="nftmax-trendmeta">
                                                                <div class="nftmax-trendmeta__main">
                                                                    <div class="nftmax-trendmeta__author">
                                                                        <div class="nftmax-trendmeta__img">
                                                                            <img src="{{ asset($FeaturedArtist['0']) }}"
                                                                                alt="#">
                                                                        </div>
                                                                        <div class="nftmax-trendmeta__content">
                                                                            <span class="nftmax-trendmeta__small">Owned
                                                                    ...
                                                                    <div class="nftmax-trendmeta__author">
                                                                        <div class="nftmax-trendmeta__content">
                                                                            <span
                                                                                class="nftmax-trendmeta__small">Create
                                                                                by</span>
                                                                            <h4 class="nftmax-trendmeta__title">
                                                                                {{ $FeaturedArtist['2'] }}</h4>
                                                                        </div>
                                                                        <div class="nftmax-trendmeta__img">
                                                                            <img src="{{ asset($FeaturedArtist['3']) }}"
                                                                                alt="#">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="trending-action__head">
                                                                ...
                                                                <img src="{{ asset($FeaturedArtist['5']) }}"
                                                                    alt="#">
                                                            </div>
                                                            <!-- Trending Body -->
                                                            <div
                                                                class="trending-action__body trending-marketplace__body">
                                                                <h2 class="trending-action__title"><a
                                                                        href="{{ url('/market-place') }}">{{ $FeaturedArtist['6'] }}</a>
                                                                </h2>
                                                                <div class="nftmax-currency">
                                                                    <div class="nftmax-currency__main">
                                                                        <div class="nftmax-currency__icon"><img
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-12">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="trending-action__body trending-marketplace__body">
                                                                <h2 class="trending-action__title"><a
                                                                        href="marketplace-details.html">{{ $FeaturedArtist['6'] }}</a>
                                                                </h2>
                                                                <div class="nftmax-currency">
                                                                    <div class="nftmax-currency__main">
                                                                        <div class="nftmax-currency__icon"><img
                                                                                src="{{ asset($OpenMarket['7']) }}"
                                                                                alt="#"></div>
                                                                        <div class="nftmax-currency__content">
                                                                            <h4 class="nftmax-currency__content-title">
                                                                                {{ $OpenMarket['8'] }} ETH </h4>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-12">
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                class="trending-action__body trending-marketplace__body">
                                                                <h2 class="trending-action__title"><a
                                                                        href="{{ url('/market-place') }}">{{ $PartnerShops['6'] }}</a>
                                                                </h2>
                                                                <div class="nftmax-currency">
                                                                    <div class="nftmax-currency__main">
                                                                        <div class="nftmax-currency__icon"><img
