                        ...
                        <div class="nftmax-wallet__dashboard">
                            <div class="row nftmax-gap-30">
                                <div class="col-lg-6 col-12">
                                    ...
                                    <div class="nftmax-balance__current nftmax-bg__cover mg-top-40"
                                        style="background-image:url('assets/img/current-balance__bg.png')">
                                        <div class="nftmax-balancetop">
                                            <div class="nftmax-balance__wallet-box">
                                                {{ $wellateStatistic['No_of_wallate'] }} <span>Wallets</span></div>
                                            <div class="nftmax-transaction">
                                                <h3 class="nftmax-transaction__title">
                                                    {{ $wellateStatistic['Total_transection'] }}</h3>
                                        ...
                                        <div class="nftmax-balance__wallet-current">
                                            ...
                                            <h2 class="nftmax-balance__wallet-amount">
                                                ${{ $wellateStatistic['current_balance'] }}</h2>
                                            <p class="nftmax-balance__wallet-add">+{{ $wellateStatistic['growth'] }}
                                                <span>({{ $wellateStatistic['growth_percentage'] }}%)</span>
                                            </p>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            <div class="nftmax-sellbox__single nftmax-sellbox__sell mg-top-40">
                                                ...
                                                <div class="nftmax-amount__statics">
                                                    <h4 class="nftmax-amount__statics__title">
                                                        {{ $BitsthisMonthData['ETH'] }} ETH</h4>
                                                    <p class="nftmax-amount__statics__text">
                                                        (${{ $BitsthisMonthData['usd'] }})<span
                                                            class="nftmax-amount__statics__debit">{{ $BitsthisMonthData['growth'] }}
                                                            ({{ $BitsthisMonthData['growth_percentage'] }}%)</span></p>
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="nftmax-sellbox__single nftmax-sellbox__earning mg-top-40">
                                                <div class="nftmax-sellbox__heading">
                                                    <h4 class="nftmax-sellbox__heading-title">Sell Earing this Month
                                                    </h4>
                                                </div>
                                                <div class="nftmax-amount__statics">
                                                    <h4 class="nftmax-amount__statics__title">
                                                        {{ $SellEaringthisMonth['ETH'] }} ETH</h4>
                                                    <p class="nftmax-amount__statics__text">
                                                        (${{ $SellEaringthisMonth['usd'] }})<span
                                                            class="nftmax-amount__statics__credit">{{ $SellEaringthisMonth['growth'] }}
                                                            ({{ $SellEaringthisMonth['growth_percentage'] }}%)</span>
                                                    </p>
                                                </div>
                                                <div class="nftmax-sidebar__cside-one">
                                                ...
                                                <ul class="nav nav-tabs  nftmax-dropdown__list" id="nav-tab"
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        <a class="nftmax-sidebar_btn nftmax-heading__tabs nav-link dropdown-toggle"
                                                            ...
                                                            aria-expanded="false">Last 15 days <span
                                                                class="nftmax-table__arrow--icon"><svg width="13"
                                                        ...
                                                        <ul class="dropdown-menu nftmax-sidebar_dropdown">
                                                            <a class="dropdown-item list-group-item"
                                                                data-bs-toggle="tab" data-bs-target="#table_1"
                                                                role="tab">Daily</a>
                                                            <a class="dropdown-item list-group-item"
                                                                data-bs-toggle="tab" data-bs-target="#table_2"
                                                                role="tab">15 days</a>
                                                            <a class="dropdown-item list-group-item"
                                                                data-bs-toggle="tab" data-bs-target="#table_3"
                                                                role="tab">Monthly</a>
                                                        </ul>
                                                    </li>
                                                </ul>
                            ...
                            <div class="row nftmax-gap-30">
                                    ...
                                    <div class="charts-main charts-main__sellh mg-top-40">
                                        <div class="charts-main__heading">
                                            ...
                                            <div class="charts-main__middle">
                                                ...
                                                <div class="charts-main__middle-single">
                                                    <p class="charts-main__middle-text nftmax-total__sales">Total Sell
                                                    </p>
                                                </div>
                                            </div>
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        <ul class="dropdown-menu nftmax-sidebar_dropdown">
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#chart__sell" role="tab">Last 7
                                                                Days </a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#chart__sell_15days"
                                                                role="tab">Last 15 Days</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#chart__sell_30days"
                                        ...
                                        <div class="charts-main__one">
                                            <div class="tab-content" id="nav-tabContent">
                                                <div class="tab-pane fade show active" id="chart__sell"
                                                    role="tabpanel" aria-labelledby="chart__sell">
                                                    <canvas id="myChart_one"></canvas>
                                                </div>
                                                <div class="tab-pane fade" id="chart__sell_15days" role="tabpanel"
                                                    aria-labelledby="chart__sell">
                                                    <canvas id="myChart_one_15days"></canvas>
                                                </div>
                                                <div class="tab-pane fade" id="chart__sell_30days" role="tabpanel"
                                                    aria-labelledby="chart__sell">
                                ...
                                <div class="col-lg-6 col-12 nftmax-sixth-two">
                                    ...
                                    <div class="nftmax-newtrans  mg-top-40">
                                        ...
                                        <div
                                            class="nftmax-newtrans__box nftmax-newtrans__box__inner  charts-main__tops">
                                            <div class="nftmax-newtrans__heading">
                                                <h3 class="nftmax-newtrans__title">Top Sell Country </h3>
                                                <!-- Features Tab List -->
                                                <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                                                    <li class="nav-item dropdown">
                                                        <a class="nftmax-sidebar_btn nftmax-heading__tabs nav-link "
                                                            data-bs-toggle="dropdown" href="#" role="button"
                                                            aria-expanded="false">View All <span
                                                                class="nftmax-table__arrow--icon"><svg width="13"
                                                                    height="6" viewBox="0 0 13 6" fill="none"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path opacity="0.7"
                                                        ...
                                                        <ul class="dropdown-menu nftmax-sidebar_dropdown">
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                href="#country_1" role="tab">Daily</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                href="#country_2" role="tab">Weekly</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                href="#country_3" role="tab">Monthly</a>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="tab-content" id="nav-tabContent">
                                                <div class="tab-pane fade show active" id="country_1"
                                                    role="tabpanel">
                                                    <!-- NFTMax Balance List -->
                                                            ...
                                                            <li class="nftmax-newtrans__single">
                                                                <div class="nftmax-newtrans__info">
                                                                    <div class="nftmax-newtrans__icon"><img
                                                                            src="{{ asset($TopSellCountry['0']) }}"
                                                                            alt="#"></div>
                                                                    <h4 class="nftmax-newtrans__added">
                                                                        {{ $TopSellCountry['1'] }}</h4>
                                                                </div>
                                                                <div
                                                                    class="nftmax-balance-amount nftmax-newtrans__amount">
                                                                    <h4 class="nftmax-balance-amount">
                                                                        {{ $TopSellCountry['2'] }} ETH</h4>
                                                                </div>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                    <div class="view-wallet__btn top-sell"><a href="#">See
                                                            All</a></div>
                                                </div>
                                                    ...
                                                    <ul class="nftmax-newtrans__list nftmax-topsell__country ">
                                                        @foreach ($TopSellCountryWeekly as $TopSellCountryWeekly)
                                                            <li class="nftmax-newtrans__single">
                                                                <div class="nftmax-newtrans__info">
                                                                    <div class="nftmax-newtrans__icon"><img
                                                                            src="{{ asset($TopSellCountryWeekly['0']) }}"
                                                                            alt="#"></div>
                                                                    <h4 class="nftmax-newtrans__added">
                                                                        {{ $TopSellCountryWeekly['1'] }}</h4>
                                                                </div>
                                                                <div
                                                                    class="nftmax-balance-amount nftmax-newtrans__amount">
                                                                    <h4 class="nftmax-balance-amount">
                                                                        {{ $TopSellCountryWeekly['2'] }} ETH</h4>
                                                                </div>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                    <div class="{{ url('/sell') }}"><a href="#">View All
                                                            Transaction</a></div>
                                                </div>
                                                    ...
                                                    <ul class="nftmax-newtrans__list nftmax-topsell__country ">
                                                        @foreach ($TopSellCountryMonthly as $TopSellCountryMonthly)
                                                            <li class="nftmax-newtrans__single">
                                                                <div class="nftmax-newtrans__info">
                                                                    <div class="nftmax-newtrans__icon"><img
                                                                            src="{{ asset($TopSellCountryMonthly['0']) }}"
                                                                            alt="#"></div>
                                                                    <h4 class="nftmax-newtrans__added">
                                                                        {{ $TopSellCountryMonthly['1'] }}</h4>
                                                                </div>
                                                                <div
                                                                    class="nftmax-balance-amount nftmax-newtrans__amount">
                                                                    <h4 class="nftmax-balance-amount">
                                                                        {{ $TopSellCountryMonthly['2'] }} ETH</h4>
                                                                </div>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                    <div class="view-wallet__btn view-trnsc"><a href="#">View
                                                            All Transaction</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="tab-pane fade show active" id="table_1" role="tabpanel"
                                                ...
                                                <table id="nftmax-table__main"
                                                    ...
                                                    <thead class="nftmax-table__head">
                                                        <tr>
                                                            <th class="nftmax-table__column-1 nftmax-table__h1">List
                                                            </th>
                                                            <th class="nftmax-table__column-2 nftmax-table__h2">Publish
                                                                date</th>
                                                            <th class="nftmax-table__column-3 nftmax-table__h3">
                                                                Products Name</th>
                                                            <th class="nftmax-table__column-4 nftmax-table__h4">Type
                                                            </th>
                                                            <th class="nftmax-table__column-5 nftmax-table__h5">Sell
                                                            </th>
                                                            <th class="nftmax-table__column-6 nftmax-table__h6">
                                                                Tendered</th>
                                                            <th class="nftmax-table__column-7 nftmax-table__h7">
                                                                Earnings</th>
                                                        </tr>
                                                    </thead>
                                                    <!-- NFTMax Table Body -->
                                                        ...
                                                        @foreach ($productHistory as $productHistory)
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <span
                                                                        class="nftmax-table__text"><b>{{ $i++ }}</b></span>
                                                                </td>
                                                                <td
                                                                ...
                                                                <td
                                                                    ...
                                                                    <div class="nftmax-table__product">
                                                                        <div class="nftmax-table__product-img">
                                                                            <img src="{{ asset($productHistory['1']) }}"
                                                                                alt="#">
                                                                        </div>
                                                                        <div class="nftmax-table__product-content">
                                                                            <h4 class="nftmax-table__product-title">
                                                                                {{ $productHistory['2'] }}</h4>
                                                                            <p class="nftmax-table__product-desc">Owned
                                                                                by <a
                                                                                    href="#">{{ $productHistory['3'] }}</a>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
