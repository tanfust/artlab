                            ...
                            <div class="row nftmax-gap-30">
                                    ...
                                    <div class="nftmax-history mg-top-40">
                                        <div class="nftmax-history__main">
                                            <div class="nftmax-history__content">
                                                <div class="nftmax-history__icon nftmax-history__icon-one"><img
                                                        src="assets/img/history-icon-1.png" alt="#"></div>
                                                <div class="nftmax-history__text">
                                                    <h4 class="nftmax-history__number"><span
                                                            class="number">{{ $HistoryData['Total_sell'] }}</span></h4>
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="nftmax-history mg-top-40">
                                        <div class="nftmax-history__main">
                                            <div class="nftmax-history__content">
                                                <div class="nftmax-history__icon nftmax-history__icon-two"><img
                                                        src="assets/img/history-icon-2.png" alt="#"></div>
                                                <div class="nftmax-history__text">
                                                    <h4 class="nftmax-history__number"><span
                                                            class="number">{{ $HistoryData['Active_Customer'] }}</span>k+
                                                    </h4>
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="nftmax-history mg-top-40">
                                        <div class="nftmax-history__main">
                                            <div class="nftmax-history__content">
                                                <div class="nftmax-history__icon nftmax-history__icon-three"><img
                                                        src="assets/img/history-icon-3.png" alt="#"></div>
                                                <div class="nftmax-history__text">
                                                    <h4 class="nftmax-history__number"><span
                                                            class="number">{{ $HistoryData['Total_product'] }}</span>
                                                    </h4>
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="nftmax-history mg-top-40">
                                        <div class="nftmax-history__main">
                                            <div class="nftmax-history__content">
                                                <div class="nftmax-history__icon nftmax-history__icon-four"><img
                                                        src="assets/img/history-icon-4.png" alt="#"></div>
                                                <div class="nftmax-history__text">
                                                    <h4 class="nftmax-history__number"><span
                                                            class="number">{{ $HistoryData['CloseOffer'] }}</span></h4>
                                    ...
                                    <div class="charts-main  mg-top-30">
                                                ...
                                                <ul class="nav nav-tabs nftmax-dropdown__list" id="nav-tab"
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        <a class="nftmax-sidebar_btn nftmax-heading__tabs nav-link dropdown-toggle"
                                                            ...
                                                            aria-expanded="false">Last 15 days <i
                                                                class="fa-solid fa-angle-down"></i></a>
                                                        <ul class="dropdown-menu nftmax-sidebar_dropdown">
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#m_history" role="tab">Last 15
                                                                Days</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#m_history_7days" role="tab">Last 7
                                                                Days</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#m_history_30days" role="tab">Last
                                                                30 Days</a>
                                                        </ul>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="charts-main__three">
                                            <div class="tab-content" id="nav-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="m_history_7days" role="tabpanel"
                                                    aria-labelledby="nav-home-tab">
                                                    <canvas id="myChart_market_history_7days"></canvas>
                                                </div>
                                                <div class="tab-pane fade" id="m_history_30days" role="tabpanel"
                                                    aria-labelledby="nav-home-tab">
                                    ...
                                    <div class="charts-main charts-home-one mg-top-40">
                                            ...
                                            <div class="nftmax-chart__dropdown">
                                                <ul class="nav nav-tabs nftmax-dropdown__list" id="nav-tab"
                                                    ...
                                                    <li class="nav-item dropdown">
                                                        ...
                                                        <ul class="dropdown-menu nftmax-sidebar_dropdown">
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#chart__visitor" role="tab">Last
                                                                15 Days</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#chart__visitor_7days"
                                                                role="tab">Last 7 Days</a>
                                                            <a class="list-group-item" data-bs-toggle="list"
                                                                data-bs-target="#chart__visitor_30days"
                                        ...
                                        <div class="charts-main__one">
                                            <div class="tab-content" id="nav-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="chart__visitor_7days" role="tabpanel"
                                                    aria-labelledby="chart__visitor">
                                                    <canvas id="myChart_two_7days"></canvas>
                                                </div>
                                                <div class="tab-pane fade" id="chart__visitor_30days" role="tabpanel"
                                                    aria-labelledby="chart__visitor">
                                                    ...
                                                    <thead class="nftmax-table__head">
                                                        <tr>
                                                            <th class="nftmax-table__column-1 nftmax-table__h1">All
                                                                Products</th>
                                                            <th class="nftmax-table__column-2 nftmax-table__h2">Value
                                                            </th>
                                                            <th class="nftmax-table__column-3 nftmax-table__h3">USD
                                                            </th>
                                                            <th class="nftmax-table__column-4 nftmax-table__h4">24H%
                                                            </th>
                                                            <th class="nftmax-table__column-5 nftmax-table__h5">Bids
                                                            </th>
                                                            <th class="nftmax-table__column-6 nftmax-table__h6">Time
                                                            </th>
                                                        ...
                                                        @foreach ($AllNFTSUpdate as $user)
                                                            <tr>
                                                                ...
                                                                <td
                                                                    ...
                                                                    <div
                                                                        class="nftmax-table__amount nftmax-table__text-one">
                                                                        <img src="assets/img/eth-icon.png"
                                                                            alt="#"><span
                                                                ...
                                                                <td
                                                                    ...
                                                                    <div
                                                                        class="nftmax-table__amount nftmax-table__text-two">
                                                                        <img src="assets/img/usd-icon.png"
                                                                            alt="#"><span
                                                                ...
                                                                <td
                                                                    ...
                                                                    <p
                                                                        class="nftmax-table__text nftmax-table__bid-text">
                                                                        {{ $user['6'] }}</p>
                                                                </td>
                                                                <td
                                                                ...
                                                                @if ($user['8'] == 1)
                                                                    <td
                                                                        class="nftmax-table__column-7 nftmax-table__data-7">
                                                                        <div
                                                                            class="nftmax-table__status nftmax-sbcolor">
                                                                            Active</div>
                                                                    </td>
                                                                @else
                                                                    <td
