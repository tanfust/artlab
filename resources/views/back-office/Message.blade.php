                                            ...
                                            @foreach ($AllMessage as $AllMessage)
                                                <li>
                                                    <div class="nftmax-chatbox__author">
                                                        ...
                                                        <div class="nftmax-chatbox__author-content">
                                                            <h4 class="nftmax-chatbox__author-title">
                                                                {{ $AllMessage['1'] }}</h4>
                                                            <p class="nftmax-chatbox__author-desc">
                                                                {{ $AllMessage['2'] }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="nftmax-chatbox__right">
                                                        ...
                                                        <span
                                                            class="nftmax-chatbox__unread">{{ $AllMessage['4'] }}</span>
                                                    </div>
                                                </li>
                                            @endforeach
                                            <!-- End Single List -->
                                ...
                                <div class="col-lg-7 col-md-7 col-12">
                                    <div class="nftmax-chatbox__explore">
                                        <div class="nftmax-chatbox__explore-head">
                                            ...
                                            <div class="nftmax-chatbox__right-bar"><i
                                        ...
                                        <div class="nftmax-chatbox__explore-body">
                                                ...
                                                <ul class="nftmax-chatbox__incoming-list">
                                                    ...
                                                    <li>
                                                        <div class="nftmax-chatbox__chat">
                                                            <div
                                                                class="nftmax-chatbox__main-content nftmax-chatbox__only-text">
                                                                <div class="nftmax-chatbox__incoming-chat">
                                                                    <p class="nftmax-chatbox__incoming-text">next time
                                                                        you'll be awake at this hour why not now</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="nftmax-chatbox__chat">
                                                            <div
                                                                class="nftmax-chatbox__main-content nftmax-chatbox__only-text">
                                                                <div class="nftmax-chatbox__incoming-chat">
                                                                    <p class="nftmax-chatbox__incoming-text">Didn't I
                                                                        tell you not to put your phone on charge just
                                                                        because it's the weekend?</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                            ...
                                                            <div class="nftmax-chatbox__main-content">
                                                                <div class="nftmax-chatbox__incoming-chat">
                                                                    <ul class="nftmax-chatbox__imoji">
                                                                        <li><img src="assets/img/imoji.png"
                                                                                alt="#"></li>
                                                                        <li><img src="assets/img/imoji.png"
                                                                                alt="#"></li>
                                                                        <li><img src="assets/img/imoji.png"
                                                                ...
                                                                <p
                                                                    class="nftmax-chatbox__time  nftmax-chatbox__time-two">
                                                                    Sat 5:10 AM</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                ...
                                                <ul class="nftmax-chatbox__incoming-list">
                                                    ...
                                                    <li>
                                                        <div class="nftmax-chatbox__chat">
                                                            <div class="nftmax-chatbox__main-content">
                                                                <div class="nftmax-chatbox__incoming-chat">
                                                                    <p class="nftmax-chatbox__incoming-text">i woke up
                                                                        calmnnn i put it on the charger the phone was
                                                                        turned off next to me i took it out while i was
                                                                        sleeping hsadfkagshdfgsajf i slept early girl i
                                                                        slept at 3</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="nftmax-chatbox__chat">
                                                            <div class="nftmax-chatbox__main-content">
                                                                <div class="nftmax-chatbox__incoming-chat">
                                                                    <p class="nftmax-chatbox__incoming-text">While you
                                                                        win in love, you continue to win in other things
                                                                        dhdhdhdh into the find to make</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="nftmax-chatbox__chat">
                                                            <div class="nftmax-chatbox__main-content">
                                                                <div class="nftmax-chatbox__incoming-chat">
                                                                    <ul class="nftmax-chatbox__imoji">
                                                                        <li><img src="assets/img/fire.png"
                                                                                alt="#"></li>
                                                                        <li><img src="assets/img/fire.png"
                                                                                alt="#"></li>
                                                                    </ul>
                                            ...
                                            <div class="nftmax-chatbox__archive-date"><span
                                                    class="nftmax-chatbox__archive-time">August 22</span></div>
                                            ...
                                            <div class="nftmax-chatbox__incoming">
                                                <ul class="nftmax-chatbox__incoming-list">
                                                    ...
                                                    <li>
                                                        <div class="nftmax-chatbox__chat">
                                                            <div
                                                                class="nftmax-chatbox__main-content nftmax-chatbox__only-text">
                                                                <div class="nftmax-chatbox__incoming-chat">
                                                                    <p class="nftmax-chatbox__incoming-text">Hey ! Bro
                                                    ...
                                                    <li>
                                                        <div class="nftmax-chatbox__chat">
                                                            <div class="nftmax-chatbox__author-img">
                                                                <img src="assets/img/chat-author11.png"
                                                                    alt="#">
                                                            </div>
                                                            <div class="nftmax-chatbox__main-content">
                                                                <div class="nftmax-chatbox__incoming-chat">
                                                    ...
                                                    <form class="nftmax-chatbox__form-inner" action="#">
                                                        ...
                                                        <div class="nftmax-chatbox__button">
                                                            <div class="nftmax-chatbox__button-inline">
                                                                <div class="nftmax-chatbox__btn nftmax-chatbox__imoji">
                                                                    <a href="#"><i
                                                                            class="fa-solid fa-face-smile"></i></a>
                                                                </div>
                                                                <div class="nftmax-chatbox__btn nftmax-chatbox__link">
                                                                    <a href="#"><i
                                                                            class="fa-solid fa-link"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="nftmax-chatbox__submit">
                                                                <button class="nftmax-chatbox__submit-btn"
                                                                    type="submit">Send<i
